...
export function useCreateResourceMutation(
	options?: UseMutationOptions<IResource, Error, ICreateResourceParams>,
) {
...
export function useUpdateResourceMutation(
	options?: UseMutationOptions<
		IResource,
		Error,
		{ id: number; data: IUpdateResourceParams }
	>,
) {
	const queryClient = useQueryClient();
	return useMutation({
...
// 切换资源状态
export function useToggleResourceStatusMutation(
	options?: UseMutationOptions<IResource, Error, number>,
) {
	const queryClient = useQueryClient();
	return useMutation({
