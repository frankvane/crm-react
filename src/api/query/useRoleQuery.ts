...
export function useCreateRoleMutation(
	options?: UseMutationOptions<IRole, Error, ICreateRoleParams>,
) {
...
export function useUpdateRoleMutation(
	options?: UseMutationOptions<
		IRole,
		Error,
		{ id: number; data: IUpdateRoleParams }
	>,
) {
	const queryClient = useQueryClient();
	return useMutation({
...
export function useToggleRoleStatusMutation(
	options?: UseMutationOptions<IRole, Error, number>,
) {
	const queryClient = useQueryClient();
	return useMutation({
...
// 分配资源
export function useAssignResourcesMutation(
	options?: UseMutationOptions<IRole, Error, IAssignResourcesParams>,
) {
	const queryClient = useQueryClient();
	return useMutation({
