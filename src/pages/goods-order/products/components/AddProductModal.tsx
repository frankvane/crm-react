...
interface AddProductModalProps {
  open: boolean;
  onOk: (values: ICreateProductParams) => Promise<void>;
  onCancel: () => void;
  brands: SelectOption[];
        ...
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item
              ...
              label="药品编码"
              rules={[
                { max: 255, message: '药品编码不能超过255个字符' }
              ]}
            >
          ...
          <Col span={12}>
            <Form.Item
              ...
              label="生产厂家"
              rules={[
                { max: 255, message: '生产厂家不能超过255个字符' }
              ]}
            >
          ...
          <Col span={12}>
            <Form.Item
              ...
              label="批准文号"
              rules={[
                { max: 255, message: '批准文号不能超过255个字符' }
              ]}
            >
          ...
          <Col span={12}>
            <Form.Item
              ...
              label="零售价"
              rules={[
                { type: 'number', min: 0, message: '零售价不能小于0' }
              ]}
            >
              <InputNumber
                style={{ width: '100%' }}
          ...
          <Col span={12}>
            <Form.Item
              ...
              label="产品图片"
              rules={[
                { max: 255, message: '图片URL不能超过255个字符' }
              ]}
            >
